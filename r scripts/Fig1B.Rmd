...
fcs <- list.files(path = "C:/Users/Steven Makatsa/OneDrive - UW/Shared Documents - SeshadriLab/Members/MakatsaSteven/CyTOF/Tricia_s samples/Matt_s samples/Main/data_analysis/FlowSOM/BAL_Leukocytes/fcs_files", pattern =".fcs$")

fs <- read.flowSet(fcs, path = "C:/Users/Steven Makatsa/OneDrive - UW/Shared Documents - SeshadriLab/Members/MakatsaSteven/CyTOF/Tricia_s samples/Matt_s samples/Main/data_analysis/FlowSOM/BAL_Leukocytes/fcs_files", transformation = FALSE, truncate_max_range = FALSE)
...
```{r, message=F}
merging_table1 <- "mergemacs2.xlsx"
...
write.csv(table, "C:/Users/Steven Makatsa/OneDrive - UW/Shared Documents - SeshadriLab/Members/MakatsaSteven/CyTOF/Tricia_s samples/Matt_s samples/Main/data_analysis/FlowSOM/BAL_Leukocytes/out/Fig.1D.csv", row.names=FALSE)
```
